...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cold-bush-ee92
```

A live public deployment of this template is available at [https://cold-bush-ee92.templates.workers.dev](https://cold-bush-ee92.templates.workers.dev)
